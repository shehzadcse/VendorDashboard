       ...
       <div class="card-body bg-light">
          <form name="profileForm" action="{{route('edit_admin_profile_save') }}" method="post">
            ...
            <div class="row gx-3 mb-3">
                <div class="col-md-6"> <label class="small mb-1" for="inputFirstName">Name</label> <input class="form-control" id="inputFirstName"  placeholder="Enter your Name" value="{!! $data[0]->name !!}" name="inputFirstName"></div>
            ...
            <div class="row gx-3 mb-3">
                ...
                <div class="col-md-6"> <label class="small mb-1" for="inputAltEmailAddress">Alternate Email address</label> <input class="form-control" id="inputAltEmailAddress" type="email" placeholder="Enter your email address" value="{{$data[0]->alt_email}}" name="inputAltEmailAddress"></div>
             </div>
