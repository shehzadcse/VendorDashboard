        ...
        <table id="adminTable" class="table table-bordered table-striped dataTable dtr-inline">
            <thead>
                <tr align="left">
                    ...
                    <th data-sortable="false">Vendor Name </th>
            ...
            <tbody>
                <tr>
                    <td>bii-support-001</td>
                    <td>Shehzad Rana</td>
                    <td>Active</td>
                    <td>Defect</td>
                    <td>High</td>
                    <td><button type="button" class="btn btn-info" data-toggle="modal" data-target="#adminModal" data-id='1' name="manage_btn">Manage </button></td>
                </tr>
                <tr>
                    ...
                    <td>Defect</td>
                    <td>High</td>
                    <td><button type="button" class="btn btn-info" data-toggle="modal" data-target="#adminModal" data-id='2' name="manage_btn">Manage </button></td>
                </tr>
            </tbody>
        </table>
