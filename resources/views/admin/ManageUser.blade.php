           ...
           columns: [
               ...
               { 
                ...
                //    return '<div class="text-center"><button class="text-center btn-sm btn-info"> Manage </button><div></div></div>';
                   return '<div class="text-center"> <button type="button" class="btn btn-info" data-toggle="modal" data-target="#userModal" data-id='+data.id+' name="manage_btn">Manage </button></div>';
                }
               }, 
            ],
            buttons: ["csv", "excel"],
